				...
				<div class="col-lg-6">
						<div class="panel panel-default">
							<div class="panel-heading panel-heading-blue">
								<span class="panel-title pull-left"> All Roles </span> <a
								...
								<table class="table table-condensed table-hover"
									...
									<tbody>
										<c:forEach items="${page.content}" var="role">
											<tr>
												<td class="f-500 c-cyan">${role.id}</td>
												<td>${role.name}</td>
												<td>
												<div class="btn-group">
    <a href="${contextPath}/role/view?id=${role.id}" class="btn btn-success" title="View"><i class="fa fa-eye"></i><span class="hidden-xs"> View</span></a>
    <button  data-href="${contextPath}/role/delete?id=${role.id}" data-project="${role.name}" class="btn btn-danger" title="Delete" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-times"></i><span class="hidden-xs"> Delete</span></button>
</div> 
												</td>
											</tr>
										</c:forEach>
