					...
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-blue">
							<span class="panel-title pull-left"> All Projects </span> <a
								href="${contextPath}/project" class="btn btn-success pull-right"><i
												...
												<td>
													<div class="btn-group">
														<a href="${contextPath}/project/users/${project.id}"
															...
															class="hidden-xs"> Users</span></a> <a
															href="${contextPath}/project/view?id=${project.id}"
															class="btn btn-success" title="View"><i
															class="fa fa-eye"></i><span class="hidden-xs">
																View</span></a>
														<button
															data-href="${contextPath}/project/delete?id=${project.id}"
															data-project="${project.name}" class="btn btn-danger"
			...
			<div class="modal-dialog">
				<div class="modal-content panel-default">
					...
					<div class="modal-body">
						<p>
							You are about to delete project <span class="proj-name"></span>
							from the system
						</p>
